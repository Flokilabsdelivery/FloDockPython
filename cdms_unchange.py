...
files_location=['C:/Users/cbt/Desktop/python/CDMS/2023-08-01']
...
for i in files_location:
    ...
    try:
        ...
        if (CDMS_properties['cdms_file1']) in os.listdir(i):
            ...
            response = requests.post(url = CDMS_properties['main_app']+'crm/saveDudepStatus',headers = {'X-AUTH-TOKEN':CDMS_properties['x-auth-token'],'Content-Type':'application/json'},json = prelim_body)
